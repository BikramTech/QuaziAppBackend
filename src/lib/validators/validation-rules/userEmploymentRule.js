...
const GetUserEmploymentsByUserIdRule = [check("user_id").isMongoId().withMessage("Invalid user  id")];

const DeleteUserEmploymentRule = [check("id").isMongoId().withMessage("Invalid user employment id")];
